...
typedef struct sc_pkcs15_card {
	...
	char cached_auth_pin[PTEID_PIN_MAX_LENGTH + 1];
	int cached_auth_pin_len;
...
int sc_pkcs15_verify_pin_no_alert(struct sc_pkcs15_card *card,
