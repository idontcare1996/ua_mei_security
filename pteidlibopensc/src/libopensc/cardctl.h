...
enum {
	...
	/*
	 * Pteid-GemSafe specific calls
	 */
	SC_CARDCTL_PTEID_BASE = _CTL_PREFIX('P', 'T', 'G'),
	SC_CARDCTL_PTEID_GET_PIN_INFO,

	/*
	 * Pteid-IAS specific calls
	 */
	SC_CARDCTL_ILEID_BASE = _CTL_PREFIX('P', 'T', 'I'),
	SC_CARDCTL_ILEID_GET_PIN_INFO,
};
...
struct sc_cardctl_pteid_pin_info {         /* GemSafe applet */
	int pinref;    /* IN: the pin ref */
	int pintries;  /* OUT: the remaining PIN tries */
	int maxtries;  /* OUT: maximum number of PIN tries */
	int maxlen;    /* OUT: max PIN length */
	int minlen;    /* OUT: min PIN length */
};
