...
#if defined(_WIN32)
#define PKCS11_DEFAULT_MODULE_NAME	"pteidpkcs11"
#elif defined(__APPLE__)
#define PKCS11_DEFAULT_MODULE_NAME	"/usr/local/lib/pteidpkcs11.dylib"
#else
#define PKCS11_DEFAULT_MODULE_NAME	"libpteidpkcs11.so"
#endif
